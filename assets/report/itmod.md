...
|             |             | support.    |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 8           | Any agency  | Identify a  | OMB and DHS | 180 days    |
|             | that has an | remediation |             |             |
|             | HVA         | plan,       |             |             |
|             | identified  | including a |             |             |
|             | as having a | proposal    |             |             |
|             | major or    | for         |             |             |
|             | critical    | acceleratin |             |             |
|             | weakness in | g           |             |             |
|             | either a    | modernizati |             |             |
|             | risk        | on          |             |             |
|             | assessment, | within one  |             |             |
|             | RVA, SAR,   | year and    |             |             |
|             | or agency   | identificat |             |             |
|             | sponsored   | ion         |             |             |
|             | review      | of          |             |             |
|             |             | impediments |             |             |
|             |             | in policy,  |             |             |
...
|             |             | as HVAs.    |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 9           | Any agency  | Identify a  | OMB and DHS | 180 days    |
|             | that has an | remediation |             |             |
|             | HVA         | plan,       |             |             |
|             | identified  | including a |             |             |
|             | as having a | proposal    |             |             |
...
|             |             | on.         |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 11          | DHS         | Expand the  | \[For       | 180 days    |
|             |             | availabilit | internal    |             |
|             |             | y           | action\]    |             |
|             |             | of DHS RVAs |             |             |
|             |             | and SARS    |             |             |
|             |             | for agency  |             |             |
...
|             |             | 70.         |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 12          | OMB (in     | Capture     | Government- | 365 days    |
|             | coordinatio | standard    | wide        |             |
|             | n           | operating   | release     |             |
|             | with DHS,   | procedures  |             |             |
|             | GSA,        | for the     |             |             |
|             | Federal     | protection  |             |             |
...
| Migration   |
+-------------+-------------+-------------+-------------+-------------+
| 13          | OMB         | Submit a    | Government- | 30 days     |
|             |             | data call   | wide        |             |
|             |             | to agencies | release     |             |
|             |             | requesting  |             |             |
|             |             | submission  |             |             |
...
|             |             | migration.  |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 14          | Agencies    | Respond to  | OMB         | Commensurat |
|             |             | OMB data    |             | e           |
|             |             | call.       |             | with        |
|             |             |             |             | timelines   |
|             |             | Propose a   |             | in the data |
|             |             | cloud       |             | call        |
|             |             | migration   |             | request     |
|             |             | plan that   |             |             |
|             |             | highlights  |             |             |
...
|             |             | migration.  |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 15          | GSA, DHS,   | Review      | \[For       | 60 days     |
|             | OMB, NSC,   | agency data | internal    |             |
|             | USDS, and   | call        | action\]    |             |
|             |             | responses.  |             |             |
|             | other       |             |             |             |
|             | relevant    |             |             |             |
|             | parties     |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 16          | OMB         | Provide     | Government- | 60 days     |
|             |             | preliminary | wide        |             |
|             |             | update to   | release     |             |
|             |             | TIC policy  |             |             |
|             |             | that        |             |             |
...
|             |             | s.          |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 17          | Agencies    | Require     | OMB, DHS,   | 90 days     |
|             |             | collection  | GSA, NSC    |             |
|             |             | of metrics  |             |             |
|             |             | that will   |             |             |
|             |             | be used to  |             |             |
...
|             |             | risk.       |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 18          | GSA, DHS,   | Kick off a  | \[For       | 90 days     |
|             | OMB, USDS,  | 90-day      | internal    |             |
|             | NSC         | sprint to   | action\]    |             |
|             |             | validate    |             |             |
|             |             | particular  |             |             |
|             |             | case        |             |             |
|             |             | studies for |             |             |
...
|             |             | projects.   |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 19          | GSA, DHS,   | For         | \[For       | 90 days     |
|             | and OMB     | category 3  | internal    |             |
|             |             | cloud       | action\]    |             |
|             |             | migration   |             |             |
|             |             | projects,   |             |             |
|             |             | work with   |             |             |
...
|             |             | cloud.      |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 20          | OMB, GSA,   | Using       | Government- | 180 days    |
|             | and DHS     | information | wide        |             |
|             |             | gathered    | release     |             |
|             |             | from        |             |             |
|             |             | previous    |             |             |
|             |             | actions,    |             |             |
...
| Management  |
+-------------+-------------+-------------+-------------+-------------+
| 21          | DHS         | Provide GSA | GSA         | 60 days     |
|             |             | and         |             |             |
|             |             | agencies    |             |             |
|             |             | with        |             |             |
|             |             | baseline    |             |             |
...
|             |             | under EIS.  |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 22          | GSA, in     | Develop a   | Government- | 90 days     |
|             | coordinatio | comprehensi | wide        |             |
|             | n           | ve          | release     |             |
...
|             |             | agencies.   |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 24          | GSA         | Provide     | Small &     | None given  |
|             |             | guidance to | independent |             |
|             |             | small       | agencies    |             |
|             |             | agencies on |             |             |
|             |             | how best to |             |             |
|             |             | leverage    |             |             |
...
| ure         |
+-------------+-------------+-------------+-------------+-------------+
| 25          | OMB         | Issue data  | Government- | 30 days     |
|             |             | call that   | wide        |             |
|             |             | will have   | release     |             |
|             |             | agencies    |             |             |
|             |             | identify    |             |             |
...
|             |             | s.          |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 26          | Agencies    | Respond to  | OMB         | Commensurat |
|             |             | OMB data    |             | e           |
|             |             | call.       |             | with        |
|             |             |             |             | timelines   |
|             |             |             |             | in the data |
...
|             |             |             |             | request     |
+-------------+-------------+-------------+-------------+-------------+
| 27          | OMB and GSA | Review the  | \[For       | Conclusion  |
|             |             | impediments | internal    | of data     |
|             |             | to moving   | action\]    | call        |
|             |             | to the      |             |             |
|             |             | cloud       |             |             |
|             |             | outlined by |             |             |
|             |             | agencies    |             |             |
...
|             |             | migrations  |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 28          | GSA (with   | Work with   | Government- | 90 days     |
|             | OMB)        | volunteer   | wide        |             |
|             |             | agencies to | release     |             |
|             |             | pilot new   |             |             |
|             |             | initiatives |             |             |
...
|             |             | enterprise. |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 29          | OMB, in     | Update the  | Government- | 120 days    |
|             | coordinatio | Federal     | wide        |             |
|             | n           | Cloud       | release     |             |
|             | with DHS    | Computing   |             |             |
|             | and other   | Strategy    |             |             |
...
|             |             | s.          |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 30          | OMB         | Conduct a   | Government- | 120 days    |
|             |             | thorough    | wide        |             |
|             |             | review of   | release     |             |
|             |             | all         |             |             |
|             |             | relevant    |             |             |
...
|             |             | policy.     |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 31          | OMB, in     | Develop     | Government- | 120 days    |
|             | coordinatio | clauses     | wide        |             |
|             | n           | that define | release     |             |
|             | with the    | consistent  |             |             |
|             | FAR         | requirement |             |             |
|             | Council,    | s           |             |             |
|             | GSA, and    | for         |             |             |
...
|             |             | contracts.  |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 32          | OMB,        | Assemble a  | Government- | 180 days    |
|             | working     | tiger team  | wide        |             |
|             | with the    | to develop  | release     |             |
|             | FAR         | a set of    |             |             |
|             | Council,    | proposed    |             |             |
|             | GSA, and    | acquisition |             |             |
|             | DHS         | statutory   |             |             |
...
|             | Tools       |
+-------------+-------------+-------------+-------------+-------------+
| 33          | OMB         | Conduct a   | Government- | 30 days     |
|             |             | data call   | wide        |             |
|             |             | to agencies | release     |             |
|             |             | regarding   |             |             |
|             |             | their       |             |             |
...
|             |             | mailboxes.  |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 34          | Agencies    | Respond to  | OMB         | Commensurat |
|             |             | OMB data    |             | e           |
|             |             | call.       |             | with        |
|             |             |             |             | timelines   |
|             |             |             |             | in the data |
...
|             |             |             |             | request     |
+-------------+-------------+-------------+-------------+-------------+
| 35          | OMB         | Convene a   | Government- | 30 days     |
|             |             | task force  | wide        |             |
|             |             | of agencies | release     |             |
|             |             | to finalize |             |             |
|             |             | a set of    |             |             |
...
|             |             | on.         |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 36          | OMB         | Establish a | N/A         | 60 days     |
|             |             | comprehensi |             |             |
|             |             | ve          |             |             |
|             |             | strategy    |             |             |
|             |             | for driving |             |             |
...
|             |             | email.      |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 37          | OMB         | Issue       | Government- | 75 days     |
|             |             | updated     | wide        |             |
|             |             | identity    | release     |             |
|             |             | policy      |             |             |
|             |             | guidance    |             |             |
...
|             | Tiger Team  | Request for | release     |             |
|             |             | Information |             |             |
|             |             | (RFI) or    |             |             |
|             |             | conduct     |             |             |
|             |             | other       |             |             |
...
|             |             | challenges. |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 41          | OMB, in     | Create a    | \[For       | 240 days    |
|             | coordinatio | pilot new   | internal    |             |
|             | n           | acquisition | action\]    |             |
|             | with GSA    | tactics for |             |             |
|             |             | cloud email |             |             |
|             |             | and         |             |             |
|             |             | collaborati |             |             |
|             |             | on          |             |             |
...
|             |             | Appendix D. |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 42          | GSA         | Continue to | \[For       | None given  |
|             |             | work with   | internal    |             |
|             |             | existing    | action\]    |             |
|             |             | cloud email |             |             |
|             |             | and         |             |             |
...
| Services    |
+-------------+-------------+-------------+-------------+-------------+
| 43          | DHS, in     | Complete    | Government- | 60 days     |
|             | partnership | the         | wide        |             |
|             | with GSA    | acquisition | release     |             |
|             |             | strategy    |             |             |
|             |             | for new,    |             |             |
|             |             | long-term   |             |             |
|             |             | task orders |             |             |
...
|             |             | and 4.      |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 44          | DHS         | Obtain      | \[For       | 125 days    |
|             |             | initial ATO | internal    |             |
|             |             | for CDM     | action\]    |             |
|             |             | Group F     |             |             |
|             |             | Platform.   |             |             |
|             |             |             |             |             |
...
|             |             | posture.    |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 46          | DHS, in     | Implement a | \[For       | 180 days    |
|             | partnership | concept of  | internal    |             |
|             | with the    | operations  | action\]    |             |
|             | Federal CIO | for the     |             |             |
|             | Council     | Federal     |             |             |
|             |             | dashboard   |             |             |
|             |             | as well as  |             |             |
...
|             |             | enterprise. |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 47          | OMB, GSA,   | Identify    | \[For       | 180 days    |
|             | and DHS     | potential   | internal    |             |
|             |             | offerings   | action\]    |             |
|             |             | to provide  |             |             |
|             |             | SOC as a    |             |             |
|             |             | Service     |             |             |
...
|             |             | Government. |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 48          | GSA, in     | Lead        | Government- | 180 days    |
|             | coordinatio | contracting | wide        |             |
|             | n           | efforts to  | release     |             |
|             | with OMB    | also offer  |             |             |
|             | and DHS     | commerciall |             |             |
|             |             | y           |             |             |
|             |             | available   |             |             |
...
|             |             | agencies.   |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 49          | Selected    | Provide a   | OMB and DHS | 210 days    |
|             | Agency/ies  | pricing     |             |             |
|             |             | model in    |             |             |
|             |             | alignment   |             |             |
|             |             | with the    |             |             |
...
|             |             | Report.     |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 50          | DHS         | Work with   | \[For       | None given  |
|             |             | SOC-as-a-Se | internal    |             |
|             |             | rvice       | action\]    |             |
|             |             | providers   |             |             |
|             |             | to ensure   |             |             |
|             |             | that NCPS   |             |             |
...
[^20]: NIST Special Publication 800-145, *The NIST Definition of Cloud
    Computing.*

[^21]: “25 Point Implementation Plan to Reform Federal Information
    Technology Management.” December 2010.

[^22]: TechFAR Hub, *8(a) Program Digital Service Initiative*.

[^23]: OMB Memorandum M-14-03, *Enhancing the Security of Federal
    Information and Information Systems*.

[^24]: Coordination of Federal Information Policy – Information Security
    (44 U.S.C. § 3553(b)(6)).

[^25]: See NIST SP 800-133, *Recommendation for Cryptographic Key
    Generation*.

[^26]: See NIST SP 800-167, *Guide to Application Whitelisting*.

[^27]: See NIST SP 800-124, *Guidelines for Managing the Security of
    Mobile Devices in the Enterprise*.

[^28]: United States Digital Service, *July 2017 Report to Congress,*
